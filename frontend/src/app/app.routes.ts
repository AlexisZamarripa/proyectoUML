...
import { GeneradorPromptComponent } from './Admin/GeneradorPrompt/generador-prompt.component';
...
export const routes: Routes = [
    ...
    { path: 'proyecto/:id/generar-prompt', component: GeneradorPromptComponent },
